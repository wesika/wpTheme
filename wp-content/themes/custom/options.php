...
function optionsframework_options() {
	...
	$options[] = array( "name" => "Header Logo",
						"desc" => "max height 85px",
						"id" => "header_logo",
						"std" => "",
						"type" => "upload");

	$options[] = array( "name" => "Content Background",
						"desc" => "content background settings",
						"id" => "background_container",
						"std" => "#FFFFFF;",
						"type" => "color");
	
	$options[] = array( "name" => "Header Logo",
						"desc" => "Logo to sit on the right of the Header",
						"id" => "header_logo",
						"std" => "",
						"type" => "upload");
	...
	$options[] = array( "name" => "Top nav link hover color",
	...
	$options[] = array( "name" => "Top nav item hover color",
						"desc" => "Item hover color.",
						"id" => "top_nav_hover_color",
						"std" => "#333333",
						"type" => "color");

	$options[] = array( "name" => "Top nav item active color",
						"desc" => "Link active color.",
						"id" => "top_nav_link_active_color",
						"std" => "#2ba6cb",
						"type" => "color");
